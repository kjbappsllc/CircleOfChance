...
extension SKAction {
    ...
    private class func animateKeyPath(keyPath: String, byValue initialDistance: CGFloat!, toValue finalValue: CGFloat!, duration: NSTimeInterval, delay: NSTimeInterval, usingSpringWithDamping dampingRatio: CGFloat, initialSpringVelocity velocity: CGFloat) -> SKAction {
